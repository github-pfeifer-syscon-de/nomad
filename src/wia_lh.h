...
IWiaPropertyStorage : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetPropertyStream(
        GUID *pCompatibilityId,
        IStream **ppIStream) = 0;

    virtual HRESULT STDMETHODCALLTYPE SetPropertyStream(
        GUID *pCompatibilityId,
        IStream *pIStream) = 0;
...
/*** IWiaPropertyStorage methods ***/
static inline HRESULT IWiaPropertyStorage_ReadMultiple(IWiaPropertyStorage* This,ULONG cpspec,const PROPSPEC rgpspec[],PROPVARIANT rgpropvar[]) {
    return This->lpVtbl->ReadMultiple(This,cpspec,rgpspec,rgpropvar);
}
static inline HRESULT IWiaPropertyStorage_WriteMultiple(IWiaPropertyStorage* This,ULONG cpspec,const PROPSPEC rgpspec[],const PROPVARIANT rgpropvar[],PROPID propidNameFirst) {
    return This->lpVtbl->WriteMultiple(This,cpspec,rgpspec,rgpropvar,propidNameFirst);
}
static inline HRESULT IWiaPropertyStorage_DeleteMultiple(IWiaPropertyStorage* This,ULONG cpspec,const PROPSPEC rgpspec[]) {
    return This->lpVtbl->DeleteMultiple(This,cpspec,rgpspec);
}
static inline HRESULT IWiaPropertyStorage_ReadPropertyNames(IWiaPropertyStorage* This,ULONG cpropid,const PROPID rgpropid[],LPOLESTR rglpwstrName[]) {
    return This->lpVtbl->ReadPropertyNames(This,cpropid,rgpropid,rglpwstrName);
}
static inline HRESULT IWiaPropertyStorage_WritePropertyNames(IWiaPropertyStorage* This,ULONG cpropid,const PROPID rgpropid[],const LPOLESTR rglpwstrName[]) {
    return This->lpVtbl->WritePropertyNames(This,cpropid,rgpropid,rglpwstrName);
}
static inline HRESULT IWiaPropertyStorage_DeletePropertyNames(IWiaPropertyStorage* This,ULONG cpropid,const PROPID rgpropid[]) {
    return This->lpVtbl->DeletePropertyNames(This,cpropid,rgpropid);
}
static inline HRESULT IWiaPropertyStorage_Commit(IWiaPropertyStorage* This,DWORD grfCommitFlags) {
    return This->lpVtbl->Commit(This,grfCommitFlags);
}
static inline HRESULT IWiaPropertyStorage_Revert(IWiaPropertyStorage* This) {
    return This->lpVtbl->Revert(This);
}
static inline HRESULT IWiaPropertyStorage_Enum(IWiaPropertyStorage* This,IEnumSTATPROPSTG **ppenum) {
    return This->lpVtbl->Enum(This,ppenum);
}
static inline HRESULT IWiaPropertyStorage_SetTimes(IWiaPropertyStorage* This,const FILETIME *pctime,const FILETIME *patime,FILETIME *pmtime) {
    return This->lpVtbl->SetTimes(This,pctime,patime,pmtime);
}
static inline HRESULT IWiaPropertyStorage_SetClass(IWiaPropertyStorage* This,REFCLSID clsid) {
    return This->lpVtbl->SetClass(This,clsid);
}
static inline HRESULT IWiaPropertyStorage_Stat(IWiaPropertyStorage* This,STATPROPSETSTG *pstatpsstg) {
    return This->lpVtbl->Stat(This,pstatpsstg);
}
static inline HRESULT IWiaPropertyStorage_GetPropertyAttributes(IWiaPropertyStorage* This,ULONG cpspec,PROPSPEC rgpspec[],ULONG rgflags[],PROPVARIANT rgpropvar[]) {
    return This->lpVtbl->GetPropertyAttributes(This,cpspec,rgpspec,rgflags,rgpropvar);
}
static inline HRESULT IWiaPropertyStorage_GetCount(IWiaPropertyStorage* This,ULONG *pulNumProps) {
    return This->lpVtbl->GetCount(This,pulNumProps);
}
static inline HRESULT IWiaPropertyStorage_GetPropertyStream(IWiaPropertyStorage* This,GUID *pCompatibilityId,IStream **ppIStream) {
    return This->lpVtbl->GetPropertyStream(This,pCompatibilityId,ppIStream);
}
static inline HRESULT IWiaPropertyStorage_SetPropertyStream(IWiaPropertyStorage* This,GUID *pCompatibilityId,IStream *pIStream) {
    return This->lpVtbl->SetPropertyStream(This,pCompatibilityId,pIStream);
}
#endif
#endif
...
IEnumWIA_FORMAT_INFO : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE Clone(
        IEnumWIA_FORMAT_INFO **ppIEnum) = 0;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumWIA_FORMAT_INFO, 0x81befc5b, 0x656d, 0x44f1, 0xb2,0x4c, 0xd4,0x1d,0x51,0xb4,0xdc,0x81)
#endif
#else
...
interface IEnumWIA_FORMAT_INFO {
    CONST_VTBL IEnumWIA_FORMAT_INFOVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT IEnumWIA_FORMAT_INFO_QueryInterface(IEnumWIA_FORMAT_INFO* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IEnumWIA_FORMAT_INFO_AddRef(IEnumWIA_FORMAT_INFO* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IEnumWIA_FORMAT_INFO_Release(IEnumWIA_FORMAT_INFO* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumWIA_FORMAT_INFO methods ***/
static inline HRESULT IEnumWIA_FORMAT_INFO_Next(IEnumWIA_FORMAT_INFO* This,ULONG celt,WIA_FORMAT_INFO *rgelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
static inline HRESULT IEnumWIA_FORMAT_INFO_Skip(IEnumWIA_FORMAT_INFO* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
static inline HRESULT IEnumWIA_FORMAT_INFO_Reset(IEnumWIA_FORMAT_INFO* This) {
    return This->lpVtbl->Reset(This);
}
static inline HRESULT IEnumWIA_FORMAT_INFO_Clone(IEnumWIA_FORMAT_INFO* This,IEnumWIA_FORMAT_INFO **ppIEnum) {
    return This->lpVtbl->Clone(This,ppIEnum);
}
static inline HRESULT IEnumWIA_FORMAT_INFO_GetCount(IEnumWIA_FORMAT_INFO* This,ULONG *pcelt) {
    return This->lpVtbl->GetCount(This,pcelt);
}
#endif
#endif
...
IWiaTransfer : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE Download(
        LONG lFlags,
        IWiaTransferCallback *pIWiaTransferCallback) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE EnumWIA_FORMAT_INFO(
        IEnumWIA_FORMAT_INFO **ppEnum) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IWiaTransfer, 0xc39d6942, 0x2f4e, 0x4d04, 0x92,0xfe, 0x4e,0xf4,0xd3,0xa1,0xde,0x5a)
#endif
#else
...
interface IWiaTransfer {
    CONST_VTBL IWiaTransferVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static inline HRESULT IWiaTransfer_QueryInterface(IWiaTransfer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static inline ULONG IWiaTransfer_AddRef(IWiaTransfer* This) {
    return This->lpVtbl->AddRef(This);
}
static inline ULONG IWiaTransfer_Release(IWiaTransfer* This) {
    return This->lpVtbl->Release(This);
}
/*** IWiaTransfer methods ***/
static inline HRESULT IWiaTransfer_Download(IWiaTransfer* This,LONG lFlags,IWiaTransferCallback *pIWiaTransferCallback) {
    return This->lpVtbl->Download(This,lFlags,pIWiaTransferCallback);
}
static inline HRESULT IWiaTransfer_Upload(IWiaTransfer* This,LONG lFlags,IStream *pSource,IWiaTransferCallback *pIWiaTransferCallback) {
    return This->lpVtbl->Upload(This,lFlags,pSource,pIWiaTransferCallback);
}
static inline HRESULT IWiaTransfer_Cancel(IWiaTransfer* This) {
    return This->lpVtbl->Cancel(This);
}
static inline HRESULT IWiaTransfer_EnumWIA_FORMAT_INFO(IWiaTransfer* This,IEnumWIA_FORMAT_INFO **ppEnum) {
    return This->lpVtbl->EnumWIA_FORMAT_INFO(This,ppEnum);
}
#endif
#endif
